...
-- Chronology ends in 476 CE. Existing IDs are retained for save and voice compatibility.
-- Religio Provinciarum hooks: doctrine_slots, religion_pressure_bonus,
-- holy_city_integrity_bonus, tolerance_trade_bonus, holy_city_power.
return {
    centuriate_levy = {
    ...
    sacred_calendar = {
        ...
        unlocks = {
            ...
            "система: Провинциальное религиозное давление",
        },
    },
    augural_colleges = {
    ...
    provincial_law = {
        ...
        unlocks = {
            ...
            "бонус Integrity святых городов",
        },
    },
    iron_armories = {
    ...
    universal_citizenship = {
        ...
        effects = {
            gold_percent = 0.02,
            unrest_reduction = 1,
            tolerance_trade_bonus = 0.06,
        },
        era = 5,
        branch = "Право и государственное управление",
        unlocks = {
            "чудо света: Таблицы гражданства Каракаллы",
            "бонус толерантной религиозной политики",
        },
    },
    ...
    imperial_cult = {
        ...
        unlocks = {
            ...
            "чудо света: Храм Марса Мстителя",
            "слот религиозной доктрины и усиление святых городов",
        },
    },
    provincial_archives = {
